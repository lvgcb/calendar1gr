...
let schedules = {
    "Пн": ["Тарих", "Физика", "Информатика", "Матем", "Агылшын", "Физика", "Орыс тили"],
    "Вт": ["Информатика", "Агылшын", "Казак тили", "Матем", "Физра", "Биология", "Физика"],
    "Ср": ["Адебиет", "Тарих", "Информатика", "Химия", "Физика", "Матем", "Биология"],
    "Чт": ["Тарих", "Орыс тили", "Казак тили", "Матем", "Агылшын", "География", "Матем"],
    "Пт": ["География", "Дене", "Информатика", "Матем", "Химия", "Физика", "Матем"],
    "Сб": ["Отдых", "", "", "", ""],
    "Вс": ["Отдых", "", "", "", ""]
};
